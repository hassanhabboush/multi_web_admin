...
import 'package:multi_web_admin/views/screens/side_bar_screens/widgets/category_widgets.dart';
...
class _CategoriesScreenState extends State<CategoriesScreen> {
  ...
  uploadCategory() async {
    EasyLoading.show();
    //   هذه الدالة تفحص  TextFormField اذا فيه قيمة ام لا
    if (_formKey.currentState!.validate()) {
      ...
      await _firestore.collection('categories').doc(fileName).set({
        ...
        setState(() {
          _image = null;
          _formKey.currentState!.reset(); //  حتى تفرخ TextForm لكتابة شيء اخر
        });
      });
    } else {
      print('OH Bad Guy ');
